...
export const ContactsView: React.FC<ContactsViewProps> = ({ 
  ...
  const [activeTab, setActiveTab] = useState<'cockpit' | 'opos' | 'list' | 'balances'>('cockpit');
  ...
  // Defined masterDataList to fix missing name error
              ...
              <div className="p-8">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                      <div className="bg-slate-50 p-6 rounded-xl border border-slate-100">
                          ...
                          <p className="text-3xl font-bold text-slate-800 mt-2">{calculateTotalDue().toLocaleString('de-DE', {minimumFractionDigits: 2})} €</p>
                      </div>
                      <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col justify-center items-start">
                          ...
                          <button 
                                ...
                                className={`w-full flex items-center justify-center px-4 py-3 text-white rounded-lg font-bold shadow-md transition-all hover:scale-[1.02] ${viewMode === 'debtors' ? 'bg-blue-600 hover:bg-blue-700' : 'bg-orange-600 hover:bg-orange-700'}`}
                            >
                      ...
                      <div className="bg-red-50 p-6 rounded-xl border border-red-100 flex flex-col justify-center items-start">
                        ...
                        <button 
                                onClick={() => openStorno()}
                                className="w-full flex items-center justify-center px-4 py-3 bg-white border border-red-200 text-red-700 hover:bg-red-50 rounded-lg font-bold transition-all shadow-sm active:scale-95"
                            >
