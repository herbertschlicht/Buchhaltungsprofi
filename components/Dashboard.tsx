...
import { Sparkles, TrendingUp, TrendingDown, DollarSign, Wallet, Activity } from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({ transactions, accounts }) => {
  ...
  const handleGenerateInsight = async () => {
    ...
    try {
        ...
        setInsight("Die Analyse konnte nicht durchgeführt werden.");
    } finally {
      ...
      {insight && (
        <div className="bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-100 p-6 rounded-3xl text-indigo-900 animate-fadeIn shadow-inner relative">
            <div className="flex justify-between items-start mb-3">
                ...
                {tokensUsed !== null && (
                    <div className="flex items-center gap-1.5 px-2.5 py-1 bg-white/60 border border-indigo-200 rounded-full text-[10px] font-bold text-indigo-600 shadow-sm" title="Gesamtverbrauch dieser Analyse">
