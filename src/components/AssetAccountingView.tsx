...
import { Transaction, Account, Asset, TransactionType } from '../types';
import { Monitor, Calculator, PlusCircle, FileText, PenLine, Calendar, Printer } from 'lucide-react';
...
export const AssetAccountingView: React.FC<AssetAccountingViewProps> = ({ transactions, accounts, assets, onBookDepreciation, onSaveAsset }) => {
  ...
  const handleRunDepreciation = () => {
      ...
      // SKR 03 Abschreibungen = 4830000
      const expenseAccount = accounts.find(a => a.code === '4830000');
      if (!expenseAccount) {
          alert("Fehler: Konto 4830000 (Abschreibungen) nicht gefunden.");
          return;
      }
